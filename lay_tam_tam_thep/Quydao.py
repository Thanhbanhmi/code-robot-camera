                ...
                try:
                    ...
                    if isinstance(frame, np.ndarray):
                            if self.Mode == 0:  # Chế độ stream
                                ...
                                corner_metal_points = []        # Mảng lưu các điểm tọa độ trên Metal
...
#-------------------------------Di chuyển đến tâm tấm thép----------------------------------------------------------------------#
                                        ...
                                        self.P0_center_metal = calculate_center_of_metal(corner_metal_points, camera_params, log_callback)
                                        log_callback(f"P0_center_metal: {self.P0_center_metal.flatten()}")
#-------------------------------------------------------------------------------------------------------------------------------#                             
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
#--------------------------------------------Di chuyển biên mối hàn--------------------------------------
                                self.P0_seg_list = calculate_weld_edge_points(
                                    contours, 
                                    self.camera_parameters.get(self.mode, {}), 
                                    self.step_size, 
                                    log_callback
                                )
#-------------------------------------------------------------------------------------------------------
