...
def get_camera_transformation_matrices(camera_params, log_callback):
    """
    ...
    H1_0 = np.array([[1, 0, 0, 100],  # Tọa độ trung tâm theo trục x
                     [0, 1, 0, -200],  # Tọa độ trung tâm theo trục y
                     [0, 0, 1, 0],
                     [0, 0, 0, 1]])
...
def calculate_center_of_metal(corner_metal_points, camera_params, log_callback):
    """
    ...
    Hc_0 = get_camera_transformation_matrices(camera_params, log_callback)
...
def calculate_weld_edge_points(contours, camera_params, step_size, log_callback):
    """
...
def calculate_interpolated_points(interpolated_points, camera_params, Hc_0, log_callback):
    """
